 ...
 * Time: 19:50
 */
include __DIR__ . DIRECTORY_SEPARATOR . '..'.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'plugins'.DIRECTORY_SEPARATOR.'give_emotions_posts'.DIRECTORY_SEPARATOR.'autoload.php';
	            ...
	            while ($gallery->have_posts()):
		            ...
		            foreach($galleryImages as $galleryImage):?>
                        <div class="lamp__slider-item lamp-slider__item">
                            <img class="lamp__image lamp-slider__image" src="<?php echo $galleryImage?>" alt="First lamp">
                        </div>
			            <?php
		            endforeach;
	            endwhile;
                        ...
                        <li class="card__item card__item--width card__item--margin-right">
                            ...
                            <div class="card__slider card-slider">
                                <img class="card__small-image card-slider__item" src="<?=get_stylesheet_directory_uri() . '/front/build'?>/images/house.png"
                                     alt="house image">
                                <img class="card__small-image card-slider__item" src="<?=get_stylesheet_directory_uri() . '/front/build'?>/images/forest-spirit.png"
                                ...
                                <img class="card__small-image card-slider__item" src="<?=get_stylesheet_directory_uri() . '/front/build'?>/images/forest-spirit.png"
                                     alt="forest-spirit image">
                                <img class="card__small-image card-slider__item"
                                     src="https://pp.userapi.com/c638930/v638930330/3fc67/TuTfkdeHzC0.jpg"
                                     alt="forest-spirit image">
                            </div>
                        </li>
